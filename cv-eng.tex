...
\begin{itemize}
  \item \textbf{Engineering Collective Behaviors:} In this research area, I focus on advancing the macroprogramming paradigm (programming systems from a global perspective) in the context of very large distributed systems (e.g., swarm robotics, smart cities). 
...
\cventry{2023}{Introduction to Reinforcement Learning -- 4 hours}%
 ...
 {}{}
\subsection{Tutoring}
\cventry{2022--today}{Master in Computer Science and Engineering}%
